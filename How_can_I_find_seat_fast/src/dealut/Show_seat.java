    ...
    */
	public void show_seat(ArrayList<Integer> seat, int fast) {
		...
		JPanel pane = new JPanel();
         ...
         System.out.println("¾È³ç ³ª´Â seat 1ÀÌ¾ß "+seat1);
         ConvertToString ToString= new ConvertToString();
         String str1 = ToString.toString(seat1);
         JLabel lblStation = new JLabel(str1);
         JTextArea a = new JTextArea();
         lblStation.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         getContentPane().add(a);
         a.append(str1);
         System.out.println("ÀÚ¸®¿¡ ³ª¿À´Â Ã¹¹øÂ°  "+str1);
         lblStation.setBounds(92, 105, 118, 57);
         getContentPane().add(lblStation);
         
         //2 seat
         seat1 = seat.get(1);
         System.out.println("¾È³ç ³ª´Â seat 2ÀÌ¾ß "+seat1);
         str1 = ToString.toString(seat1);
         JLabel lblStation_1 = new JLabel(str1);
         JTextArea b = new JTextArea();
         lblStation_1.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         getContentPane().add(b);
         b.append(str1);
         System.out.println("ÀÚ¸®¿¡ ³ª¿À´Â µÎ¹øÂ° "+str1);
         ...
         lblStation_2.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_3.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_4.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_5.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_6.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_7.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
         ...
         lblStation_8.setFont(new Font("RixºñÅ¸¹Î M", Font.BOLD,19));
