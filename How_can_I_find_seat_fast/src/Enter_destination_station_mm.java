...
public class Enter_destination_station_mm /*extends 그 전 확인해주는 class입력할 것!*/ {
...
//
	...
	public Enter_destination_station_mm() {
		...
		Enter_destination_station_ss.setContentPane(contentPane);//이거 3개 저 extend 때문에 오류나는 듯!
